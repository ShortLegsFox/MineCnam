...
namespace TDObject
{
    public class FireTowerFactory : I_TowerFactory
    {
        ...
        {
            GameObject prefab = GameManager.Instance.GetTowerData(Element.Fire, TowerLevel.Basic).Prefab;
        ...
        {
            GameObject prefab = GameManager.Instance.GetTowerData(Element.Fire, TowerLevel.Advanced).Prefab;
            GameObject instance = Object.Instantiate(prefab, new Vector3(0, -100, 0), Quaternion.identity);
            instance.transform.parent = Grid.Instance.transform;
            return instance.GetComponent<Tower>();
        }
        ...
        {
            GameObject prefab = GameManager.Instance.GetTowerData(Element.Fire, TowerLevel.Ultimate).Prefab;
            GameObject instance = Object.Instantiate(prefab, new Vector3(0, -100, 0), Quaternion.identity);
            instance.transform.parent = Grid.Instance.transform;
            return instance.GetComponent<Tower>();
        }
